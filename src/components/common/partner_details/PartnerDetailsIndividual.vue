...
<template>
  <q-card-section 
    class="partner-details-individual__section-snils"
    style="gap: 18px;"
  >
  ...
  <q-card-section
    class="partner-details-individual__section column"
    style="gap: 18px;"
  >
    <q-input
      ref="fioInputRef"
    ...
    <q-checkbox
      ...
      class="partner-details-individual__section pm-checkbox"
...
<style lang="scss">
.partner-details-individual__section-snils {
  display: flex;
...
.partner-details-individual__section {
  .q-field {
      min-width: 300px;      
      flex-grow: 1;
    }
